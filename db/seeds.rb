...
Student.create(name:'山田太一', sex:'男', 'age':22, department_id:4)
Student.create(name:'鈴木よし男', sex:'男', 'age':18, department_id:1)
Student.create(name:'伊藤佳奈', sex:'女', 'age':19, department_id:2)
Student.create(name:'鈴木筋肉', sex:'男', 'age':20, department_id:3)
Student.create(name:'山田ごま塩', sex:'男', 'age':22, department_id:4)
Student.create(name:'鈴木トクホ', sex:'女', 'age':18, department_id:1)
Student.create(name:'伊藤ピロミ', sex:'女', 'age':19, department_id:2)
Student.create(name:'鈴木DO', sex:'男', 'age':20, department_id:3)
Student.create(name:'細山太郎', sex:'男', 'age':22, department_id:4)
